...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    welcome_message = (
        ...
        "📚 Отправьте мне файл учебника в формате .docx, и я обработаю его "
        "через Perplexity API, заполню шаблон и верну вам готовый файл result.docx.\n\n"
...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    help_text = (
        ...
        "⚠️ Обработка файла может занять несколько минут, пожалуйста, подождите."
    )
...
async def handle_document(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    try:
        ...
        await processing_msg.edit_text(
            "Обработка файла через Perplexity API...\n"
